...
也顺便推荐我提取出来的用于组件开发场景的 VuePress 的插件 [vmi](https://github.com/bfehub/vmi)，实现了接近于 dumi 的体验和功能。
...
# VuePress 依赖
pnpm add vuepress@next @vuepress/client@next  -D --filter @bfehub/docs
```
...
# 核心开发工具包
pnpm add @vuepress/core@next @vuepress/client@next @vuepress/utils@next --filter @bfehub/vuepress-plugins

# 解析 markdown 语法工具包
pnpm add @vuepress/markdown@next @vuepress/plugin-prismjs@next --filter @bfehub/vuepress-plugins
