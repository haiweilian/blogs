...
- 你需要了解 [pnpm](https://pnpm.io/zh/installation) 的基于使用。

- 你需要了解 [vue3](https://staging-cn.vuejs.org/) 的基于使用。

- 你需要了解 [typescript](https://www.typescriptlang.org/) 的基于使用。

- 你需要了解 [nodejs](https://nodejs.org/en/) 的基于使用。

- 以及上面用到的工具都贴出了链接你可提前了解学习。

## 结尾

如果对你有帮助可以点个 **赞** 和 **关注** 以示鼓励，那么就开始我们的组件库搭建之旅吧！！！
